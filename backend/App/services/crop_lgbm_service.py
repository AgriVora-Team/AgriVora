...
def predict_crop(payload: dict) -> dict:
    ...
    try:
        ...
        for i, p in enumerate(proba):
            ...
            # Apply dynamic heuristic penalty to heavily reweigh based on pH
            penalty = 1.0
        ...
        # Take the top 3 and any others that are > 0.65 (post-penalty scaling)
        for i, (crop_name, prob) in enumerate(crop_probs):
            if i < 3 or prob > 0.65:
                # Re-normalize/Boost presentation score gently up for the winner
