...
class _ManualSoilAnalysisPageState extends State<ManualSoilAnalysisPage> {
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              children: [
                Icon(
                  _isValid ? Icons.check_circle_outline : Icons.pending_actions,
                  size: 18,
                  color: _isValid
  ...
  Widget _buildResultCard() {
    ...
    if (recommendations.isEmpty) {
      final cropName =
          _predictionResult!['recommended_crop'] ??
    ...
    final double confidence = (rec['confidence'] is num)
        ? rec['confidence'].toDouble()
        : 0.85;
